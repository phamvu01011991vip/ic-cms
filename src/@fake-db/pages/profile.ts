...
const data: DataType = {
  ...
  profile: {
    ...
    contacts: [
      ...
      { property: 'Skype', value: 'john.doe', icon: 'bxl-skype' },
      { property: 'Email', value: 'john.doe@example.com', icon: 'bx-envelope' },
    ],
    teams: [
      { property: 'Backend Developer', value: '(126 Members)', icon: 'bxl-github', color: 'secondary' },
      { property: 'VueJS Developer', value: '(98 Members)', icon: 'bxl-vuejs', color: 'success' },
    ],
    overview: [
  ...
  teams: [
    ...
    },
    {
      ...
      description:
        'The development of Vue and its ecosystem is guided by Vue team, some of whom have chosen to be featured below.',
      chips: [
        {
          title: 'Vuejs',
          color: 'success',
    ...
    },
    {
      ...
      description:
        'Explore, install, use, and remix thousands of plugins and files published by designers and developers.',
      chips: [
        {
          title: 'UI/UX',
          color: 'success',
