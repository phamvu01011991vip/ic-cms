      ...
      >
        ...
        >
          ...
          >
            ...
            <h6 class="ms-2 me-3 text-body-1 font-weight-medium text-high-emphasis">
              {{ email.from.name }}
            </h6>
            ...
            <div class="email-meta">
              <VBadge
                ...
                dot
              />
              <small class="text-xs text-disabled ms-3">{{
            ...
            <div class="email-actions d-none">
              ...
              <IconBtn @click.stop=" handleActionClick(email.isRead ? 'unread' : 'read', [email.id])">
                <VIcon :icon="email.isRead ? 'bx-envelope' : 'bx-envelope-open'" />
                <VTooltip
                  activator="parent"
                  location="top"
                >
